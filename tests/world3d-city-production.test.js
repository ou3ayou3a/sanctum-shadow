...
test('PBR materials, weather, day-night lighting, and obstruction fading are connected',()=>{
  ...
  assert.match(obstruction,/this\.occluderRecords\.filter/);assert.match(obstruction,/intersectObjects\(candidates,false\)/);assert.match(obstruction,/MathUtils\.lerp\(material\.opacity,target,blend\)/);
