...
test('Vaelthar has natural terrain, production woodland, a river corridor, and wall mist',()=>{assert.match(citySource,/vaelthar-hills/);assert.match(citySource,/vaelthar-river/);assert.match(citySource,/south-forest-road/);assert.match(citySource,/western-wall-mist/);assert.match(citySource,/river-mist/);assert.match(assetSliceSource,/forest_tree/);assert.match(assetSliceSource,/oak_tree/);assert.match(assetSliceSource,/production:tree/);});
