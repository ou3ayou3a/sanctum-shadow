...
const LOCATION_BACKGROUNDS = {
  ...
  vaelthar_slums:    { img: 'art/locations/vaelthar_slums.jpg',   gradient: 'linear-gradient(160deg, #050305 0%, #120a14 40%, #060308 100%)',       prompt: 'dark fantasy slum district, rain-soaked cobblestones, shadowy alleys, desperate faces, torches' },
  vaelthar_docks:    { img: 'art/locations/vaelthar_docks.jpg',   gradient: 'linear-gradient(160deg, #040608 0%, #08111a 40%, #040507 100%)',       prompt: 'dark harbour at night, black water, moored ships, fog rolling in, ominous lanterns' },
  temple_quarter:    { img: 'art/locations/temple_quarter.jpg',   gradient: 'linear-gradient(160deg, #080608 0%, #160d10 40%, #090508 100%)',       prompt: 'oppressive gothic cathedral quarter, blood-red stained glass, flagellant monks, heavy incense smoke' },
  covenant_hall:     { img: 'art/locations/covenant_hall.jpg',    gradient: 'linear-gradient(160deg, #100608 0%, #1e0a0d 40%, #0c0507 100%)',       prompt: 'vast cathedral interior, candle-lit altar, dark ceremony, sinister religious iconography, stone columns' },
  thornwood_gate:    { img: 'art/locations/thornwood_gate.jpg',   gradient: 'linear-gradient(160deg, #040806 0%, #0a1408 40%, #040705 100%)',       prompt: 'fortified gate at the edge of a dark forest, guards, fog, old stone walls, threatening sky' },
  ...
  monastery_aldric:  { img: 'art/locations/monastery_aldric.jpg', gradient: 'linear-gradient(160deg, #080808 0%, #121012 40%, #080608 100%)',       prompt: 'abandoned monastery on a clifftop, broken arches, moonlight through stone windows, overgrown courtyard' },
