...
(function (root, factory) {
  ...
  const QUEST_ARCS = Object.freeze({
    ...
    c1q6:{ objectives:[
      ...
      { id:'hear_confession', label:'Learn why Harren abandoned his vows.', events:['scene:harren_confession','scene:harren_field_order'] },
      { id:'resolve_harren', label:'Resolve the standoff with Sir Harren and recover his testimony.', events:['scene:harren_joins','scene:harren_field_order'], completes:true },
    ] },
    c1q7:{ objectives:[
