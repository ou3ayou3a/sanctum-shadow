(function(root,factory){const api=factory();if(typeof module==='object'&&module.exports)module.exports=api;if(root)root.PhysicalQuestFlow=api;})(globalThis,function(){
  ...
  const TARGETS=Object.freeze({
    ...
    'npc:brother_cael':{location:'monastery_aldric',label:'Speak with Brother Cael',position:[3,0,3],scene:'cael_the_last_sayer',quest:'c1q17',entrance:'interior_exit',pendingOnly:true,npc:{id:'brother_cael',name:'Brother Cael',title:'The Last Sayer',race:'human',classId:'cleric',action:'quest'}},
    ...
    'npc:head_archivist_theones':{location:'church_archive',label:'Speak with Head Archivist Theones',position:[2.8,0,-2],scene:'archive_theones_desk',quest:'c1q17',quests:['c1q17','c1q18','c1q19'],entrance:'interior_exit',requires:'met_theones',npc:{id:'head_archivist_theones',name:'Head Archivist Theones',title:'Keeper of the Buried Texts',race:'human',classId:'mage',action:'quest'}},
