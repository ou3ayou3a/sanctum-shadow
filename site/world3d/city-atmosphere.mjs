...
export class CityAtmosphere{
  constructor(engine){this.engine=engine;this.torches=[];this.lastHour=-1;this.wetness=0;this.kit=engine.zone?.profile?.kit||'road';this.baseSky=new THREE.Color(KIT_SKIES[this.kit]||DAY);}
  initialize(){
