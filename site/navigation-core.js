(function(root,factory){const api=factory();if(typeof module==='object'&&module.exports)module.exports=api;if(root)root.SanctumNavigation=api;})(globalThis,function(){
class MinHeap {
